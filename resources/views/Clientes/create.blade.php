...
<footer class="container-fluid fh5co-footer">
        <div class="container" id="contact">
            <div class="row">
                <div class="col-lg-5">
                    <h2>DIME AQUI LO QUE NECESITAS.</h2>
                ...
                <div class="col-lg-7">
                    <div class="form-box">
                        <h4>FORMULARIO DE REGISTRO PARA CONTRATAR NUESTROS SERVICIOS.</h4>
                    
                        <hr />
                        <table class="table table-light table-borderless">
                            <tr>
                                <td><input type="text" name="nombre1" class="form-control"   placeholder="Nombre:"></td> 
                                <td><input type="text" name="paterno" class="form-control"  placeholder="Apellido Paterno:"> </td>
                            </tr>
                            <tr>
                                <td><input type="text" name="materno" class="form-control"  placeholder="Apellido Materno:"></td>
                                <td><input type="text" name="edad" class="form-control"  placeholder="Edad:"> </td>
                            </tr> 
                            
                            <tr>
                                <td><input type="text" name="dia" class="form-control"  placeholder="Fecha:"></td>
                                <td><input type="text" name="evento" class="form-control"  placeholder="Evento:"></td>  
                            </tr>
        ...
        <strong>Error</strong> Por favor haga el llenado completo de los datos <br><br>
        <ul>
