...
@yield('sesiones')
<form action="{{url('/RegistrarCli')}}" method="POST">
{{csrf_field()}}
                ...
                <div class="col-lg-7">
                    <div class="form-box">
                        ...
                        <table class="table table-light table-borderless">
                            <tr>
                                <td><input type="text" name="nombrecli" class="form-control" id="nombrecli" class="nombrecli" placeholder="Nombre del cliente:"></td> 
                                <td><input type="text" name="apellidos" class="form-control" id="apellidos" class="apellidos" placeholder="Apellidos:"> </td>
                            </tr>
                            <tr>
                                <td><input type="text" name="direccion" class="form-control" id="direccion" class="direccion" placeholder="Direccion:"></td>
                                <td><input type="text" name="producto" class="form-control" id="producto" class="producto" placeholder="Producto:"> </td>
                            </tr> 
                            ...
                            <tr>
                                ...
                                <td>
                                   <button type="button gallery_button"><a href="{{ route('RegistrarCli.index')}}">CONSULTA</a></buttom>
                                   </td> 
