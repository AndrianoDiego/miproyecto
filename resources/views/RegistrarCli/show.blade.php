...
<!-- Home -->
    ...
    <h2> CONSULTA DE CLIENTE </h2>
          ...
          <center><br><br><br>
        <form action="{{ route('RegistrarCli.show', $registrarcli->id) }}" method="POST">
        {{csrf_field() }}
