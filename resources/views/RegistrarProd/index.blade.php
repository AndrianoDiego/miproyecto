...
<br><br><br><br><br>
          ...
          <div class="row">
               ...
               <div class="pull-right">
                    <a class="btn btn-success" href="{{ route('RegistrarProd.create') }}"> REGISTRAR PRODUCTO </a>
               </div>
          </div>
     </div>
@if ($message = Session::get('Aceptado'))
     ...
     <thead class="thead-light">
          ...
          <tbody>
          @foreach ($datosprod as $registrar)
          <tr>

               <td>{{ $registrar->id}} </td>
               <td>{{ $registrar->nombreprod}} </td>
               <td>{{ $registrar->marca }} </td>
               <td>{{ $registrar->proveedor }} </td>
               <td>{{ $registrar->precio }} </td>
               <td>{{ $registrar->cantidad }} </td>
          <td>
               
               <form method="post" action="{{url('/RegistrarProd/'.$registrar->id) }}">
               <a href="{{ url('/RegistrarProd/'. $registrar->id)}}"> <img src="{{asset('/images/ver.png')}}"> </a>
               <a href="{{ url('/RegistrarProd/'.$registrar->id.'/edit') }}"><img src="{{asset('/images/editar.png')}}"></a>
               {{csrf_field() }}
