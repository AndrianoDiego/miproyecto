...
<link rel="stylesheet" type="text/css" href="{{('/styles/categories_responsive.css')}}">
          ...
          <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('RegistrarProd.index')}}">BACK </a>
                </div>
            </div>
          </div>
    ...
    <form action="{{ route('RegistrarProd.update', $registrar->id) }}" method="POST" enctype="multipart/form-data">
        {{csrf_field() }}
        {{ method_field('PATCH')}}
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <input type="text" name="nombreprod" id="nombreprod" value="{{ $registrar->nombreprod}}" class="form-control">
                </div>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <input type="text" name="marca" id="marca" value="{{ $registrar->marca}}" class="form-control">
                </div>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <input type="text" name="proveedor" id="proveedor" value="{{ $registrar->proveedor}}" class="form-control">
                </div>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <input type="text" name="precio" id="precio" value="{{ $registrar->precio}}" class="form-control">
                </div>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <input type="text" name="cantidad" id="cantidad" value="{{ $registrar->cantidad}}" class="form-control">
                </div>
            </div>
         </div>
