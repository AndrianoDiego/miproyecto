...
@yield('sesiones')
<form action="{{url('/Sesiones')}}" method="POST">
{{csrf_field()}}
<footer class="container-fluid fh5co-footer">
        <div class="container" id="contact">
            <div class="row">
                <div class="col-lg-5">
                    <h2>Registrate AQUI para saber como deseas tu álbum.</h2>
                ...
                <div class="col-lg-7">
                    <div class="form-box">
                        ...
                        <table class="table table-light table-borderless">
                            <tr>
                                <td><input type="text" name="nombre2" class="form-control" id="nombre2" class="nombre2" placeholder="Nombre:"></td> 
                                <td><input type="text" name="paterno" class="form-control" id="paterno" class="paterno" placeholder="Apellido Paterno:"> </td>
                            </tr>
                            <tr>
                                <td><input type="text" name="materno" class="form-control" id="materno" class="materno" placeholder="Apellido Materno:"></td>
                                <td><input type="text" name="email" class="form-control" id="email" class="email" placeholder="Email:"> </td>
                            </tr> 
                            
                            <tr>
                                <td><input type="text" name="edad" class="form-control" id="edad" class="edad" placeholder="Edad:"> </td>
                                <td><input type="date" name="fecha" class="form-control" id="fecha" class="fecha" placeholder="Fecha:"></td> 
                            </tr>
                            <tr>
                                <td><input type="text" name="albunes" class="form-control" id="albunes" class="albunes" placeholder="Número de álbum:">
                                </td>
                            </tr>
